...
<div class="main-wrapper login-body">
  <div class="login-wrapper">
    <div class="container"> <img class="img-fluid logo-dark mb-2" src='{{ asset('logo.jpg') }}' alt="Logo">
      <div class="loginbox">
          ...
          <div class="login-right-wrap">
           ...
           <input type="hidden" id="hid" name="hid" value="0">
              <div class="form-group">
                ...
                <input id="email" name="email" type="email" class="form-control" placeholder="Type Your Email Address" value="admin@admin.com" required>
              </div>
              <div class="form-group">
                <label class="form-control-label">Password</label>
                <div class="pass-group">
                  <input type="password" id="password" name="password" class="form-control pass-input" placeholder="Your Password" value="password" required>
